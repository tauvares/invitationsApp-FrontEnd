      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Events/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Event#presence
             * @methodOf lbServices.Event
             *
             * @description
             *
             ...
             */
            "presence": {
              url: urlBase + "/Events/:id/presence",
              method: "GET",
            },
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Guests/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Guest#sendEmail
             * @methodOf lbServices.Guest
             *
             * @description
             *
             ...
             */
            "sendEmail": {
              url: urlBase + "/Guests/sendEmail",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Guest#confirmation
             * @methodOf lbServices.Guest
             *
             * @description
             *
             ...
             */
            "confirmation": {
              url: urlBase + "/Guests/:id/confirmation",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Guest#barcode
             * @methodOf lbServices.Guest
             *
             * @description
             *
